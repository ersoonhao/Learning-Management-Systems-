module.exports = app => {
    ...
    app.get('/manage/sections', async(req, res) => {
        res.sendFile(
            app._FRONT_END_PATH + '/manage/course/class/section/sections.html'
        )
    })
    app.get('/manage/section', async(req, res) => {
        res.sendFile(
            app._FRONT_END_PATH + '/manage/course/class/section/section.html'
        )
    })
    app.get('/manage/materials', async(req, res) => {
        res.sendFile(
            app._FRONT_END_PATH + '/manage/course/class/section/materials.html'
        )
    })
